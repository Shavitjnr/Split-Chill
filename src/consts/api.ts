...
export const DEFAULT_API_TIMEOUT: number = 10000; 
export const DEFAULT_UPLOAD_API_TIMEOUT: number = 30000; 
export const DEFAULT_EXPORT_API_TIMEOUT: number = 180000; 
export const DEFAULT_IMPORT_API_TIMEOUT: number = 1800000; 
export const DEFAULT_CLEAR_ALL_TRANSACTIONS_API_TIMEOUT: number = 1800000; 
export const DEFAULT_LLM_API_TIMEOUT: number = 600000; 
