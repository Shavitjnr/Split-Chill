...
const clientVersionHolder: VersionInfo = {
    version: __SPLITCHILL_AI_VERSION__,
    commitHash: __SPLITCHILL_AI_BUILD_COMMIT_HASH__,
    buildTime: __SPLITCHILL_AI_BUILD_UNIX_TIME__
};
...
export function isProduction(): boolean {
    return __SPLITCHILL_AI_IS_PRODUCTION__;
}
